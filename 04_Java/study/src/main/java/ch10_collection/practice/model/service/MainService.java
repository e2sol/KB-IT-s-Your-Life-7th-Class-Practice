...
public class MainService {
    ...
    private void signUp() {
        ...
        do {
            ...
            newMemberId = sc.nextLine();
            // 아이디 중복 검사
            for (Member m : members) {
                if (m.getMemberId().equals(newMemberId)) {
                    System.out.println("중복되는 아이디입니다. 다시 입력해주세요.");
                    newMemberId = "";
                    break;
                }
            }
        } while (newMemberId.isEmpty());


        System.out.print("비밀번호 : ");
        String newMemberPw = sc.nextLine();

        System.out.print("이름 : ");
        String newMemberName = sc.nextLine();

        members.add(new Member(newMemberId, newMemberPw, newMemberName));
