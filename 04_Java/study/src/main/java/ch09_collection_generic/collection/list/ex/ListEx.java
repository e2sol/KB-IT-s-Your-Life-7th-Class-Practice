...
public class ListEx {
    ...
    // 3) 객체만 저장 가능 - 기본 자료형 저장 불가능, but auto boxing을 통해 저장 가능하게끔.
    ...
    public void ex1() {
        ...
        System.out.println(list);
        // -> list의 크기를 초과해도 자동으로 크기가 늘어나기 때문에 에러 발생 X
        ...
        // a instanceof b : a가 b타입 이거나 b의 자식(하위 타입)이라면 true
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (list.get(i) instanceof String) {
                // 들여쓰기 자동완성 : ctrl + alt + l or ctrl + shift + f
                String str = (String) list.get(i); // 다운 캐스팅
    ...
    public void ex2() {
        ...
        // 타입 추론
        // ArrayList<>에 타입 미 작성 시 부모의 제네릭 <String>을 보고 String만 들어올 수 있게 함
