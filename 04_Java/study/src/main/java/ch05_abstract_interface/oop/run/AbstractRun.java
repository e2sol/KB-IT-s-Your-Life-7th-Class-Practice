...
import main.java.ch05_abstract_interface.oop.model.service.HHJCalculator;
...
public class AbstractRun {
    public static void main(String[] args) {
        ...
        Calculator cal = new HHJCalculator(); // 다형성

        // 코드에 큰 수정 없이 객체 생성 코드만 바꾸면 새로운 클래스의 코드를 수행할 수 있다.
