...
CREATE TABLE `MEMBER` (
	...
	`enroll_dt`	datetime	NOT NULL	DEFAULT CURRENT_TIMESTAMP	COMMENT '회원가입일 (DEFAULT CURRENT_TIMESTAMP)',
	`secession_fl`	char(1)	NOT NULL	DEFAULT 'N'	COMMENT '탈퇴 여부 (Y : 탈퇴, N : 미탈퇴, DEFAULT N")'
);
